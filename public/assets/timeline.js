 ...
 */(function () {
  ...
  var EVENTS_URL = "data/calendar-events.json?v=26459f0c";
   ...
   */
  var TYPE_ICON = {
    // 絵は viewBox（16×16）の中央に置く。y 4.5〜11.5 で中心8。
    // 2026-09-11 まで y 5.5〜12.5（中心9）で、他のアイコンより約1px下にずれていた。
    ticket: "M2 4.5h12v2a1.5 1.5 0 0 0 0 3v2H2v-2a1.5 1.5 0 0 0 0-3v-2z M9.5 5.5v1 M9.5 7.5v1 M9.5 9.5v1",
