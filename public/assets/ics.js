 ...
 * どの予定の説明欄にも入れる断り書き。
 *
 * **カレンダーに入った予定は、サイトの外へ出ていきます。** 画面の上に出している
 * 「非公式のファンツールです」の断りは付いてきません。数週間後に通知として届いたとき、
 * 本人はこの道具のことを忘れています。買い逃しが起きるとしたらそこなので、
 * 予定そのものに書きます。
 *
 * 文言をここに置いているのは、購読フィードとダウンロードで**食い違わせないため**です。
 * 何を出すかは呼ぶ側が決めますが、決めた結果が2通りになると、片方だけ断りの無い
 * 予定が出回ります。
 */
export const DISCLAIMER =
  "※非公式のファンツールによる予定です。日程が変わっている場合があります。" +
  "購入・応募の前に公式サイトで確認してください。";
