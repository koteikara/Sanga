...
const checks = [
  ...
  {
    label: 'LocalStorage key constant contract in public/assets/app.js',
    source: appJs,
    required: [
      'STORAGE_KEYS',
      'CARD_STATE_STORAGE_KEY=STORAGE_KEYS.cardStates',
      'FILTER_SETTINGS_STORAGE_KEY=STORAGE_KEYS.filter',
      'DISPLAY_MODE_STORAGE_KEY=STORAGE_KEYS.displayMode',
      'LAYOUT_STORAGE_KEY=STORAGE_KEYS.layout',
      'STORAGE_CLEAR_KEYS',
    ],
  },
  {
    label: 'LocalStorage helper contract in public/assets/app.js',
    source: appJs,
    required: [
      'readStorageValue',
      'writeStorageValue',
  ...
  {
    label: 'LocalStorage state persistence contract in public/assets/app.js',
    source: appJs,
    required: [
      'readStoredStates',
      'writeStoredStates',
