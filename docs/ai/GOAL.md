...
「docs/js-inventory.md と docs/ai/JS_CHANGE_CHECKLIST.md と docs/ai/PLAN.md に従い、public/assets/app.js の表示モード・フィルタ・表示列のデフォルト値を `DEFAULT_DISPLAY_MODE`、`DEFAULT_FILTER`、`DEFAULT_LAYOUT` として定数化する。表示モード値、フィルタ値、表示列仕様、LocalStorageキー文字列、保存形式、処理順、HTML、CSS、日程データは変更しない。Static Checksが成功し、docs/ai/WORKLOG.md に変更内容と確認結果を記録できたら完了とする。」
