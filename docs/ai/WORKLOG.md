...
`docs/dense-schedule-calendar.md` の「未確定・保留事項」に6件。主なものは次の2つです。

- 2027年1月2日〜2月8日の38日間（中断期間）を、指示どおり「中5日以上＝安全（緑）」のままにするか。
- 2027年2月以降はJ1がほぼ未確定で、日付ボックス263日のうち146日が斜線になる。量を減らすか。

### 人間が確認すべき点

別ページにするか年間スケジュールへ融合するかの判断。上の残課題2件の扱い。
